use testsql;
-- create table users (id int primary key auto_increment, name varchar(255) not null, age int null, email varchar(255) null default "admin@gmail.com", address varchar(255) null);
